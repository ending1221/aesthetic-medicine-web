...
module.exports = __webpack_require__.p + "img/banner.f0359d0.jpg";
...
module.exports = __webpack_require__.p + "img/1.7ad500d.jpg";
...
module.exports = __webpack_require__.p + "img/2.5626de0.jpg";
...
module.exports = __webpack_require__.p + "img/3.48e9298.jpg";
...
module.exports = __webpack_require__.p + "img/4.3f1f060.jpg";
...
module.exports = __webpack_require__.p + "img/5.deaf1bb.jpg";
...
module.exports = __webpack_require__.p + "img/6.ffcad2d.jpg";
...
module.exports = __webpack_require__.p + "img/7.df373c9.jpg";
...
module.exports = __webpack_require__.p + "img/8.94445a7.jpg";
...
module.exports = __webpack_require__.p + "img/9.f145c71.jpg";
...
module.exports = __webpack_require__.p + "img/10.9217519.jpg";
...
module.exports = __webpack_require__.p + "img/11.193592b.png";
...
module.exports = __webpack_require__.p + "img/12.93699e1.jpg";
...
module.exports = __webpack_require__.p + "img/13.cae90be.jpg";
...
module.exports = __webpack_require__.p + "img/案例1.c45eff1.png";
...
module.exports = __webpack_require__.p + "img/案例2.e7039ea.png";
...
module.exports = __webpack_require__.p + "img/案例3.69bc90c.png";
...
module.exports = __webpack_require__.p + "img/14.2042311.jpg";
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/service/preventiveMedicine/doe.vue?vue&type=template&id=4ba908a3&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"page-container"},[_c('el-breadcrumb',[_c('el-breadcrumb-item',{attrs:{"to":{ path: '/' }}},[_vm._v("首頁")]),_vm._v(" "),_c('el-breadcrumb-item',[_vm._v("服務項目")]),_vm._v(" "),_c('el-breadcrumb-item',[_vm._v("美膚光療")]),_vm._v(" "),_c('el-breadcrumb-item',[_vm._v("D.O.E光繞雷射")])],1),_vm._ssrNode(" "),_c('Title',{attrs:{"title":"D.O.E光繞雷射","titleEn":"D.O.E HELIOS III"}}),_vm._ssrNode(" <div class=\"article-container service-page\"><img"+(_vm._ssrAttr("src",__webpack_require__(260)))+" alt=\"D.O.E光繞雷射 Banner\"> <h2>斑的種類這麼多種，你了解你臉上的斑嗎？</h2> <p>雀斑／老人斑／曬斑／蒙古斑／胎記／肝斑／顱骨斑</p> <img"+(_vm._ssrAttr("src",__webpack_require__(261)))+" alt=\"斑的種類這麼多種，你了解你臉上的斑嗎？\"></div> <div class=\"article-container\"><h2>選對雷射除對斑，才能給你光滑蛋白肌。</h2> <h5>淨膚雷射很常見，但你知道打在臉上的是什麼嗎？</h5> <p>美仕媞時尚醫美診所提供八倍淨膚<span class=\"hasColor\">「終極版淨膚雷射」</span>，不同於以往淨膚雷射所使用的單一波長，「D.O.E光繞雷射」All-in-one與皮秒雷射運用兩種波長在1064nm 以及 532nm經由熱能刺激，能量比起淨膚雷射來的高，甚至效用<span class=\"hasColor\">媲美范冰冰最愛的皮秒雷射，價格卻比皮秒雷射更親民。</span></p> <img"+(_vm._ssrAttr("src",__webpack_require__(262)))+" alt=\"不同波長有不同效果\"> <p>「D.O.E光繞雷射」可以擊退惱人的肝斑，且不僅時間上縮短許多，熱傷害減少45%，對於改善泛紅狀況、斑點，粗大毛孔等等更有顯著效果，<span class=\"hasColor\">光繞雷射擁有四大數位探頭，泛紅剋星、擊碎斑點、毛孔對策、對抗肝斑</span>，可針對個人肌膚狀況選擇需要的療程，<span class=\"hasColor\">「D.O.E光繞雷射」All-in-one 一機多用完美到位。</span></p> <iframe src=\"https://www.youtube.com/embed/AYljJ0OWxMg\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen=\"allowfullscreen\"></iframe></div> <div class=\"article-container\"><h2>D.O.E光繞雷射HELIOS III規格</h2> <img"+(_vm._ssrAttr("src",__webpack_require__(263)))+" alt=\"D.O.E光繞雷射HELIOS III規格\"></div> <div class=\"article-container\"><h2>全新第三代「D.O.E光繞雷射」All-in-one 一機多用完美到位</h2> <p>光繞雷射是利用Q開關將雷射能量在極短的時間內瞬間輸出，在<span class=\"hasColor\">不傷害周邊組織</span>的情況下，以<span class=\"hasColor\">高效率震碎黑色素</span>，同<span class=\"hasColor\">刺激真皮層新生膠原蛋白</span>，有效<span class=\"hasColor\">改善膚色、肌膚質地及色素斑問題。</span></p> <img"+(_vm._ssrAttr("src",__webpack_require__(264)))+" alt=\"全新第三代「D.O.E光繞雷射」All-in-one 一機多用完美到位\"></div> <div class=\"article-container\"><h2>色素斑雷射原理</h2> <p>利用選擇性光熱分解的原理，當特定波長的雷 射光被黑色素吸收後，將由光能轉化為熱能再 把含有黑色素的細胞震碎裂解，達到除斑效果。</p> <img"+(_vm._ssrAttr("src",__webpack_require__(265)))+" alt=\"光繞作用\"></div> <div class=\"article-container\"><h2>光繞雷射效果作用</h2> <h3>刺激膠原蛋白新生</h3> <p>利用低能量多發數的治療刺激膠原蛋白新生，增加肌膚彈性。</p> <img"+(_vm._ssrAttr("src",__webpack_require__(266)))+" alt=\"光繞雷射兩大作用\"> <h3>擊碎黑色素</h3> <p>以25-40倍瞬間能量擊碎黑色素，改善膚色不均，淡化斑點。</p> <img"+(_vm._ssrAttr("src",__webpack_require__(267)))+" alt=\"光繞雷射兩大作用\"> <h3>改善肌膚膚質</h3> <p>新生膠原蛋白，刺激表皮更新。改善肌膚質地，重現Q彈。</p> <h3>改善毛孔粗大</h3> <p>分段式能量深入真皮層，刺激新生膠原蛋白，抑制皮脂分泌毛孔粗大。</p></div> <div class=\"article-container\"><h2>新一代淨膚終極版【D.O.E.光繞雷射】 療程特色</h2> <img"+(_vm._ssrAttr("src",__webpack_require__(268)))+" alt=\"新一代淨膚終極版【D.O.E.光繞雷射】 療程特色\"></div> <div class=\"article-container\"><h2>淨膚終極版【D.O.E.光繞雷射】四大探頭 All in One</h2> <p>一般雷射淨膚只使用在 1064nm 單一波長下的二種探頭 ( 黑色與藍色探頭 ) 來做治療，但臨床上因為各人體質差異，加上斑點的存在位置、深淺各有 不同，所以有時治療效果不一。</p> <p>為解決這問題，HELIOS III 研發出在 1064nm 以及 532nm 波長下(與皮秒雷射波長相同)，應用四種 探頭，針對不同深度的黑色素，不僅能有效去除臉上斑斑點點，大大提高療效，更能縮短治療的療程次數。</p> <img"+(_vm._ssrAttr("src",__webpack_require__(269)))+" alt=\"探頭介紹\"> <img"+(_vm._ssrAttr("src",__webpack_require__(270)))+" alt=\"專用數位透鏡\"></div> <div class=\"article-container\"><h2>光繞雷射技術特點</h2> <img"+(_vm._ssrAttr("src",__webpack_require__(271)))+" alt=\"光繞雷射技術特點\"> <img"+(_vm._ssrAttr("src",__webpack_require__(272)))+" alt=\"療程靈活自由搭配\"> <img"+(_vm._ssrAttr("src",__webpack_require__(273)))+" alt=\"更多手把更多應用\"></div> <div class=\"article-container\"><h2>適用對象</h2> <ul><li>+ 對斑點或是色素沉澱不滿意者</li> <li>+ 毛孔粗大者、角質厚或是臉部粗糙、老化者</li> <li>+ 有粉刺、青春痘疤痕者</li> <li>+ 有膚色黯沉或不均者</li> <li>+ 想要追求更好膚質者</li></ul></div> <div class=\"article-container\"><h2>美麗案例</h2> <img"+(_vm._ssrAttr("src",__webpack_require__(274)))+" alt=\"案例1\"> <img"+(_vm._ssrAttr("src",__webpack_require__(275)))+" alt=\"案例2\"> <img"+(_vm._ssrAttr("src",__webpack_require__(276)))+" alt=\"案例3\"> <p>療程效果會因個人體質而有所差異</p></div> <div class=\"article-container\"><h2>治療次數建議</h2> <p>療程次數依照每個人的狀況而不同，有些症狀需要多次的治療，才能達到預期的效果，每次治療前須先觀察皮膚恢復情況，再選擇當次治療參數。</p> <img"+(_vm._ssrAttr("src",__webpack_require__(277)))+" alt=\"治療次數建議\"></div> <div class=\"article-container\"><h2>光繞雷射常見問答</h2> <h3>Q. 新一代淨膚【光繞雷射】需要接受幾次療程才能讓毛孔縮小</h3> <p>光繞雷射是利用無創的方式刺激膠原蛋白新生，所以會需要3-6次的治療才能看到較明顯的改善，建議完成完整的療程以後，還是可以定期接受光繞雷射的治療維持效果喔！</p> <h3>Q. 數位透鏡不同在哪</h3> <p>數位透鏡可以將能量放大40倍，但同時又可降低45%的熱傷害，這樣特殊透鏡可以更有效率刺激真皮層使得纖維母細胞產生更多膠原蛋白，也可以用力40倍的超高能量有效震碎黑色素。</p> <h3>Q. 會痛嗎</h3> <p>治療當中會有輕微刺痛感以及些許溫熱的感覺，診所會依照治療方式搭配表皮麻藥膏的使用控制疼痛，整體而言治療的過程不會有太大的不適。</p> <h3>Q. 剛清完粉刺可以做嗎</h3> <p>利用物理性的方式清粉刺之後會對肌膚造成一些輕微的傷害，此時的肌膚較為脆弱，建議先休息至肌膚狀況良好時再接受光繞雷射的治療。</p></div> <div class=\"article-container\"><h2>術後小叮嚀</h2> <ul><li>- 雷射治療後，皮膚會有輕微紅熱感，如有不適可進行冰敷。</li> <li>- 術後可搭配保濕面膜或保濕導入課程。</li> <li>- 部分患者接受治療後會有痘痘或搔癢之情形發生，此為皮膚代謝之正常現象，3~5天會自然消退。</li> <li>- 療程後2天內避免使用含有果酸或酒精成分的保養品或化妝水，且一週內請勿進行其它護膚及去角質療程。</li> <li>- 淨膚雷射無開放性傷口，術後肌膚無不適即可正常洗臉化妝。 居家照護請加強保濕及防曬，減少戶外活動或避免直接曝曬陽光，白天請使用防曬係數SPF30或以上防曬品。</li> <li><h4>本療程的效果可能因個人體質的不同而有差異，請務必與醫師溝通諮詢</h4></li></ul></div>")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/service/preventiveMedicine/doe.vue?vue&type=template&id=4ba908a3&

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/service/preventiveMedicine/doe.vue
...
/* harmony default export */ var doe = __webpack_exports__["default"] = (component.exports);
