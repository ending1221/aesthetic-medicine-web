...
module.exports = __webpack_require__.p + "img/banner.f6d5042.jpg";
...
module.exports = __webpack_require__.p + "img/1.2203abe.jpg";
...
module.exports = __webpack_require__.p + "img/2.fe0e65f.jpg";
...
module.exports = __webpack_require__.p + "img/案例1.041ba00.png";
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/service/beautyService/hyaluronan.vue?vue&type=template&id=48c8e9d4&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"page-container"},[_c('el-breadcrumb',[_c('el-breadcrumb-item',{attrs:{"to":{ path: '/' }}},[_vm._v("首頁")]),_vm._v(" "),_c('el-breadcrumb-item',[_vm._v("服務項目")]),_vm._v(" "),_c('el-breadcrumb-item',[_vm._v("美學微整")]),_vm._v(" "),_c('el-breadcrumb-item',[_vm._v("玻尿酸")])],1),_vm._ssrNode(" "),_c('Title',{attrs:{"title":"玻尿酸","titleEn":"HYALURONAN"}}),_vm._ssrNode(" <div class=\"article-container service-page\"><img"+(_vm._ssrAttr("src",__webpack_require__(233)))+" alt=\"玻尿酸 Banner\"> <p>隨著微整技術不斷發達，逆轉青春之路不再遙不可及，近年來，新世代女性的完美期待，不只是看起來年輕，更希望擁有自然豐潤的好氣色，展現宛如公主、貴婦般的澎潤美肌，而美麗機密，就蘊藏於先進、安全的Princess公主玻尿酸注射療程。</p></div> <div class=\"article-container\"><h2>玻尿酸治療原理</h2> <p>Princess 公主玻尿酸是經由微生物發酵而來的凝膠型玻尿酸，具有高度黏稠性與理想的彈性，提高注射的順暢與舒適度且塑型自然，是根據高安全標準檢驗法規製成，並通過毒理學及生物相容性試驗，不致敏且安全穩定。公主玻尿酸分為大中小分子劑型，依照不同的需求施打不同的部位。 小分子劑型添加甘油，加強補水作用、改善肌膚保濕力與彈性，並達到持久的保水效果，適用於淺層紋路，如眼唇細紋、頸部或手部紋路。</p> <img"+(_vm._ssrAttr("src",__webpack_require__(234)))+" alt=\"玻尿酸治療原理\"> <ol><li>不像傳統玻尿酸容易有結塊問題</li> <li>注射過程只需15~30分鐘，可立即恢復日常生活</li> <li>添加甘油，能夠幫助保水、彈性及潤滑</li> <li>透過S.M.A.T.R.交聯技術，比起一般玻尿酸更持久穩定且自然</li></ol></div> <div class=\"article-container\"><h2>適用對象</h2> <img"+(_vm._ssrAttr("src",__webpack_require__(235)))+" alt=\"適用對象\"> <ul><li>✔ 欲改善深度皺紋，如法令紋、木偶紋眼、唇周細紋等</li> <li>✔ 欲改善臉部凹陷狀態者</li> <li>✔ 希望臉部年輕化，時效更持久、更自然</li></ul></div> <div class=\"article-container\"><h2>美麗案例</h2> <h4>玻尿酸 豐唇</h4> <img"+(_vm._ssrAttr("src",__webpack_require__(236)))+" alt=\"案例1\"> <p>療程效果會因個人體質而有所差異</p></div> <div class=\"article-container\"><h2>術前小提醒</h2> <ul><li>+ 請告知醫師自己過往病例，曾進行臉部整形手術、雷射光療，或曾經施打過任何微整形項目。</li> <li>+ 如有心臟病.高血壓或對麻藥過敏有凝血性問題，除微整形外一般動刀式整形也不建議進行。</li> <li>+ 哺乳中的婦女、對藥劑成分過敏或正在服用肌肉鬆弛症藥劑者，不建議接受療程。</li> <li>+ 醫生視情況予以局部麻醉。</li> <li>+ 可維持6 個月～8個月以上。</li> <li>+ 兩週前嘴巴周圍有發生第一型單純性疱疹症狀者不可施打。<b>*一般正常現象*</b></li></ul></div> <div class=\"article-container\"><h2>術後小叮嚀</h2> <ul><li>+ 注射後24小時形狀固定，期間避免重壓及接觸注射區域。玻尿酸術後可進行冰敷，減輕紅腫狀況（紅腫狀況依個人體質不同），但不要在注射部位熱敷。</li> <li>+ 玻尿酸注射治療後，可能會有下列暫時性的現象產生，如瘀血、發紅、疼痛、搔癢、微腫及注射部位摸到有彈性的物質存在，這些症狀都是正常的，於療程後幾天至1～2週後消失。</li> <li>+ 術後一切基礎保養正常，不要特別在區部位按摩。可進行施打部位的濕敷或者加強保濕產品護理。</li> <li>+ 一周內勿游泳∕三溫暖∕烤箱∕熱瑜珈，洗臉時務必輕柔，避免擠壓。</li> <li>+ 注射在鼻樑部位時，一周內儘量避免揉鼻子、戴眼鏡。</li> <li>+ 玻尿酸治療效果會因人而異，醫師會視個人需要，建議是否重覆注射。</li> <li>+ 療程後1～2週內回診追蹤，可視個人情況與需求追加注射。</li> <li>+ 如有用阿斯匹靈或其他類似藥物，請注意這會增加青腫及流血。</li></ul></div>")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/service/beautyService/hyaluronan.vue?vue&type=template&id=48c8e9d4&

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/service/beautyService/hyaluronan.vue
...
/* harmony default export */ var hyaluronan = __webpack_exports__["default"] = (component.exports);
...
//# sourceMappingURL=hyaluronan.js.map