...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"page-container"},[_c('el-breadcrumb',[_c('el-breadcrumb-item',{attrs:{"to":{ path: '/' }}},[_vm._v("首頁")]),_vm._v(" "),_c('el-breadcrumb-item',[_vm._v("服務項目")]),_vm._v(" "),_c('el-breadcrumb-item',[_vm._v("美麗重現")]),_vm._v(" "),_c('el-breadcrumb-item',[_vm._v("羽毛線")])],1),_vm._ssrNode(" "),_c('Title',{attrs:{"title":"羽毛線","titleEn":"PDA"}}),_vm._ssrNode(" <div class=\"article-container service-page\"><img"+(_vm._ssrAttr("src",__webpack_require__(351)))+" alt=\"羽毛線 Banner\"></div> <div class=\"article-container\"><h2>美麗功效</h2> <p>(PDO、PDS原本是美國FDA核准用於心臟外科手術的縫合線，目前已經被廣泛運用在整形手術上)。PDO、PDS線材能在皮下形成支撐力，順著肌肉紋理由下往上埋入後，如同在真皮層搭起穩固的網狀結構，能有效對抗地心引力帶來的下垂力量,尤其對於較明顯的老化鬆弛，能物理性定點穩住不斷向下移動的顏面組織，進而達到緊緻的效果。植入身體後，可被身體吸收，與皮膚組織起協同作用，所以不用拆線。</p> <img"+(_vm._ssrAttr("src",__webpack_require__(352)))+" alt=\"示意圖\"></div> <div class=\"article-container\"><h2>使用絲線材料介紹</h2> <p>(依據行政院衛生署醫療器材許可證/2012年7月13日新增中文仿單標籤核定本內容公告) 將身體可吸收的膠原蛋白線材導入皮膚後與皮膚組織起協同作用，刺激皮膚膠原蛋白增生。 新一代高科技線材：可吸收膠原蛋白線(Polydioxanone)</p> <ol><li>延展性更高、良好的柔軟度</li> <li>施打更平順、舒適度較高</li> <li>人體吸收速度慢、維持時間久(由於縫線被吸收時間較長，可能會出現刺激與出血反應)</li></ol> <img"+(_vm._ssrAttr("src",__webpack_require__(353)))+" alt=\"線材前後比較\"></div> <div class=\"article-container\"><h2>羽毛線材料介紹</h2> <ol><li>將細如髮絲的可吸收PDO、PDS蛋白線材植入皮下，約30分鐘完成。</li> <li>將全臉分成上半臉、下半臉、下巴3個部位依肌肉生長方向三段式立體4D全臉精緻拉提，自然且可維持。</li> <li>不需動刀、修復期短、不需要術後禁忌(不需積極防曬，可泡溫泉、可敷美白面膜、可運動等，詳洽詢醫師)。</li> <li>臉部若有青春痘或發炎感染狀況，最好先治療好再進行；糖尿病患或凝血功能有問題的患者，不適合進行。</li></ol></div>")],2)}
var staticRenderFns = []
