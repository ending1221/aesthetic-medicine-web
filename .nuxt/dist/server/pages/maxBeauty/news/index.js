...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/maxBeauty/news/index.vue?vue&type=template&id=1c769bae&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"page-container"},[_c('el-breadcrumb',[_c('el-breadcrumb-item',{attrs:{"to":{ path: '/' }}},[_vm._v("首頁")]),_vm._v(" "),_c('el-breadcrumb-item',[_vm._v("關於美仕媞")]),_vm._v(" "),_c('el-breadcrumb-item',[_vm._v("最新消息")])],1),_vm._ssrNode(" "),_c('Title',{attrs:{"title":"最新消息","titleEn":"NEWS"}}),_vm._ssrNode(" "),_c('NormalItem',{attrs:{"data":_vm.newsData,"pageName":"news"}}),_vm._ssrNode(" "),_c('el-pagination',{attrs:{"pager-count":11,"layout":"prev, pager, next","total":_vm.pageCount * 10,"hide-on-single-page":true,"current-page":Number(_vm.pageId)},on:{"current-change":_vm.currentChange}})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/maxBeauty/news/index.vue?vue&type=template&id=1c769bae&
...
var Normal_Item = __webpack_require__(93);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/maxBeauty/news/index.vue?vue&type=script&lang=js&
//
//
//
//
...
// CONCATENATED MODULE: ./pages/maxBeauty/news/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var maxBeauty_newsvue_type_script_lang_js_ = (newsvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/maxBeauty/news/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  maxBeauty_newsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
installComponents(component, {Title: __webpack_require__(79).default,NormalItem: __webpack_require__(93).default})
...
var ___CSS_LOADER_URL_REPLACEMENT_1___ = ___CSS_LOADER_GET_URL_IMPORT___(___CSS_LOADER_URL_IMPORT_1___);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "body,html{margin:0;padding:0;width:100vw;color:#fff;position:relative;overflow-x:hidden;font-family:\"Noto Sans TC\",Roboto,Arial,sans-serif;font-size:var(--FontSize)}.vdatetime-calendar__month__day--selected:hover>span>span,.vdatetime-calendar__month__day--selected>span>span,.vdatetime-popup__header{background:#832a57!important}.vdatetime-month-picker__item--selected,.vdatetime-popup__actions__button,.vdatetime-year-picker__item--selected{color:#832a57!important}.el-breadcrumb__inner.is-link:hover,.el-breadcrumb__inner a:hover{color:#832a57!important;cursor:pointer}.el-pagination{text-align:center;margin-top:5%}.el-pagination .el-pager li.active{color:#842b57;cursor:default}.el-pagination .el-pager li:hover{color:#842b57}.el-breadcrumb{margin-bottom:5%}@media(max-width:767px){.el-breadcrumb{margin-bottom:10%}}.el-breadcrumb__item{margin-bottom:1.5%}.el-breadcrumb__inner.is-link,.el-breadcrumb__inner a{font-weight:500!important}.el-pagination button:hover{color:#842b57!important}.page-container{width:100%;max-width:1280px;padding:0 5% 5%;margin:150px auto 0;color:#333}.page-container .index-title{margin-bottom:3%}@media(max-width:1024px){.page-container .index-title{margin-bottom:5%}}@media(max-width:1280px){.page-container{padding:0 10% 10%}}@media(max-width:767px){.page-container{margin-top:120px}}.disabled{pointer-events:none;opacity:.7}.btn{border:none;background-color:#832a57;padding:.5rem 2rem;border-radius:2px;color:#fff;font-size:105%;font-weight:200;letter-spacing:1px;cursor:pointer}.btn:hover{background-color:#602d4b}*,:after,:before{box-sizing:border-box;margin:0}#__layout,#__nuxt,.content{width:100%;height:100%}a{color:#602d4b;text-decoration:none}input[type=checkbox]{display:none}input[type=checkbox]+span{display:inline-block;padding-left:30px;line-height:20px;background:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") no-repeat 0 0;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;letter-spacing:1px}input[type=checkbox]:checked+span{background:url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ") no-repeat 0 0}.service-page.article-container img:first-child{width:100%}.article-container{color:#7d7d7d;margin-bottom:5%}.article-container b{font-weight:500}.article-container iframe{width:100%;height:40vw;margin-bottom:2.5%}.article-container .w-30{width:30%}.article-container .w-50{width:49.5%}.article-container ol{padding-left:3%}.article-container h1{color:#832a57;font-size:150%;font-weight:600;margin:5% 0 3%}.article-container h2{color:#832a57;font-size:140%;font-weight:600;margin:4% 0 2.5%}.article-container h3{color:#333;font-size:130%;font-weight:400;margin:1% 0}.article-container h4{color:#832a57;font-size:120%;font-weight:400;margin:1% 0}.article-container h5{font-size:110%;font-weight:400;margin:1% 0}.article-container li,.article-container p,.article-container span{font-size:90%;letter-spacing:1px;font-weight:300}.article-container li.hasColor,.article-container p.hasColor,.article-container span.hasColor{color:#832a57;font-size:100%;font-weight:400}.article-container p{margin-bottom:2%}.article-container img{display:block;margin:5% auto 2%;width:100%}@media screen and (max-width:992px){.article-container img{margin-bottom:5%}}.article-container .img-block{display:flex;margin:5% 0 2%}.article-container .img-block .img-block-item{flex:1;margin-right:1%}.article-container .img-block .img-block-item:last-child{margin-right:0}.article-container .img-block .img-block-item img{width:100%}.normal-items{display:flex;flex-wrap:wrap;margin-top:5%}.normal-items .item{flex:30%;margin-right:2%;margin-bottom:2%;background:#fff;box-shadow:0 0 15px rgba(51,51,51,.3);display:flex;flex-direction:column;max-height:450px;max-width:48%}.normal-items .item:nth-child(3n+3){margin-right:0}@media(max-width:768px){.normal-items .item{flex:48%}.normal-items .item:nth-child(3n+3){margin-right:2%}.normal-items .item:nth-child(2n){margin-right:0}}@media(max-width:767px){.normal-items .item{flex:100%;margin-bottom:5%;margin-right:0;max-width:100%}.normal-items .item:nth-child(2n),.normal-items .item:nth-child(3n+3){margin-right:0}}.normal-items .item .img{flex:1;overflow:hidden;min-height:200px}.normal-items .item .img img{width:100%;height:100%;-o-object-fit:cover;object-fit:cover}.normal-items .item .text{flex:1;color:#665c60;padding:5% 7.5%;position:relative;letter-spacing:1px;min-height:220px}.normal-items .item .text .time{font-size:70%;margin-bottom:2.5%}.normal-items .item .text .title{font-size:20px;font-weight:500;line-height:100%;margin-bottom:5%;display:-webkit-box;overflow:hidden;text-overflow:ellipsis;-webkit-line-clamp:2;-webkit-box-orient:vertical;line-height:20px;max-height:40px}@media(max-width:767px){.normal-items .item .text .title{font-size:16px;line-height:16px;max-height:32px}}.normal-items .item .text .detail{font-size:14px;font-weight:300;display:-webkit-box;overflow:hidden;text-overflow:ellipsis;-webkit-line-clamp:4;-webkit-box-orient:vertical;line-height:14px;max-height:56px}@media(max-width:767px){.normal-items .item .text .detail{font-size:12px;line-height:12px;max-height:48px}}.normal-items .item .text .btn{font-size:15px;line-height:100%;padding:7.5px 25px 9px;position:absolute;right:7.5%;bottom:10%}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
