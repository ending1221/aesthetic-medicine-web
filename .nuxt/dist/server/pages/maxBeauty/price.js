...
/* harmony default export */ var pricevue_type_script_lang_js_ = ({
  ...
  asyncData(context) {
    ...
    arr.forEach(item => {
      testData.push({
        id: item,
        imgsrc: __webpack_require__(194),
        title: `${item} 不讓醜陪你過聖誕`
      });
    });
  ...
  data() {
    return {
      ...
      showPrice: false,
      newPriceImgSrc: __webpack_require__(194)
    };
  },
