<template>
    <div class="page-container">
         <el-breadcrumb>
            ...
            <el-breadcrumb-item>羽毛線</el-breadcrumb-item>
        </el-breadcrumb>
        ...
        <div class="article-container">
            <h2>使用絲線材料介紹</h2>
            <p>(依據行政院衛生署醫療器材許可證/2012年7月13日新增中文仿單標籤核定本內容公告) 將身體可吸收的膠原蛋白線材導入皮膚後與皮膚組織起協同作用，刺激皮膚膠原蛋白增生。 新一代高科技線材：可吸收膠原蛋白線(Polydioxanone)</p>
            <ol>
                <li>延展性更高、良好的柔軟度</li>
                <li>施打更平順、舒適度較高</li>
        ...
        <div class="article-container">
            <h2>羽毛線材料介紹</h2>
            <ol>
                <li>將細如髮絲的可吸收PDO、PDS蛋白線材植入皮下，約30分鐘完成。</li>
                <li>將全臉分成上半臉、下半臉、下巴3個部位依肌肉生長方向三段式立體4D全臉精緻拉提，自然且可維持。</li>
                <li>不需動刀、修復期短、不需要術後禁忌(不需積極防曬，可泡溫泉、可敷美白面膜、可運動等，詳洽詢醫師)。</li>
                <li>臉部若有青春痘或發炎感染狀況，最好先治療好再進行；糖尿病患或凝血功能有問題的患者，不適合進行。</li>
            </ol>
        </div>
    </div>
</template>