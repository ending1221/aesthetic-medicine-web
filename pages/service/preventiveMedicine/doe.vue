<template>
    <div class="page-container">
         <el-breadcrumb>
            ...
            <el-breadcrumb-item>D.O.E光繞雷射</el-breadcrumb-item>
        </el-breadcrumb>
        ...
        <div class="article-container">
            ...
            <h3>改善毛孔粗大</h3>
            <p>分段式能量深入真皮層，刺激新生膠原蛋白，抑制皮脂分泌毛孔粗大。</p>
        </div>
        ...
        <div class="article-container">
            <h2>光繞雷射常見問答</h2>
            <h3>Q. 新一代淨膚【光繞雷射】需要接受幾次療程才能讓毛孔縮小</h3>
            <p>光繞雷射是利用無創的方式刺激膠原蛋白新生，所以會需要3-6次的治療才能看到較明顯的改善，建議完成完整的療程以後，還是可以定期接受光繞雷射的治療維持效果喔！</p>
            <h3>Q. 數位透鏡不同在哪</h3>
            <p>數位透鏡可以將能量放大40倍，但同時又可降低45%的熱傷害，這樣特殊透鏡可以更有效率刺激真皮層使得纖維母細胞產生更多膠原蛋白，也可以用力40倍的超高能量有效震碎黑色素。</p>
            <h3>Q. 會痛嗎</h3>
            <p>治療當中會有輕微刺痛感以及些許溫熱的感覺，診所會依照治療方式搭配表皮麻藥膏的使用控制疼痛，整體而言治療的過程不會有太大的不適。</p>
            <h3>Q. 剛清完粉刺可以做嗎</h3>
            <p>利用物理性的方式清粉刺之後會對肌膚造成一些輕微的傷害，此時的肌膚較為脆弱，建議先休息至肌膚狀況良好時再接受光繞雷射的治療。</p>
        </div>
        <div class="article-container">
            <h2>術後小叮嚀</h2>
            <ul>
                <li>- 雷射治療後，皮膚會有輕微紅熱感，如有不適可進行冰敷。</li>
                <li>- 術後可搭配保濕面膜或保濕導入課程。</li>
                <li>- 部分患者接受治療後會有痘痘或搔癢之情形發生，此為皮膚代謝之正常現象，3~5天會自然消退。</li>
                <li>- 療程後2天內避免使用含有果酸或酒精成分的保養品或化妝水，且一週內請勿進行其它護膚及去角質療程。</li>
                <li>- 淨膚雷射無開放性傷口，術後肌膚無不適即可正常洗臉化妝。 居家照護請加強保濕及防曬，減少戶外活動或避免直接曝曬陽光，白天請使用防曬係數SPF30或以上防曬品。</li>
