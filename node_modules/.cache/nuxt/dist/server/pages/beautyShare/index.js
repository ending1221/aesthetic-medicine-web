...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/beautyShare/index.vue?vue&type=template&id=283853f1&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"page-container"},[_c('el-breadcrumb',[_c('el-breadcrumb-item',{attrs:{"to":{ path: '/' }}},[_vm._v("首頁")]),_vm._v(" "),_c('el-breadcrumb-item',[_vm._v("美麗分享")])],1),_vm._ssrNode(" "),_c('Title',{attrs:{"title":"美麗分享","titleEn":"BEAUTY SHARE"}}),_vm._ssrNode(" "),_c('BeautyItem',{attrs:{"beautyData":_vm.beautyData}}),_vm._ssrNode(" <p>"+_vm._ssrEscape("pageId: "+_vm._s(_vm.pageId))+"</p> <p>"+_vm._ssrEscape("beautyData: "+_vm._s(_vm.beautyData))+"</p> <p>"+_vm._ssrEscape("currentId: "+_vm._s(_vm.currentId))+"</p> "),_c('el-pagination',{attrs:{"pager-count":11,"layout":"prev, pager, next","total":_vm.pageCount * 10,"hide-on-single-page":true,"current-page":Number(_vm.pageId)},on:{"current-change":_vm.currentChange}})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/beautyShare/index.vue?vue&type=template&id=283853f1&
